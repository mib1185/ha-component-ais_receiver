...
type AisReceiverConfigEntry = ConfigEntry[AisReceiverData]


async def async_setup_entry(hass: HomeAssistant, entry: AisReceiverConfigEntry) -> bool:
    """Set up config entry."""
    ...
    entry.runtime_data = AisReceiverData(receiver, task)
...
async def async_unload_entry(
    hass: HomeAssistant, entry: AisReceiverConfigEntry
) -> bool:

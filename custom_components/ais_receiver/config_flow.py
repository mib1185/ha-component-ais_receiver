...
class AisReceiverConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for AIS receiver."""
    ...
    async def async_step_user(self, user_input=None) -> ConfigFlowResult:
        ...
        if user_input is not None:
            return self.async_create_entry(title="AIS Receiver", data=user_input)
